package id.haadii.submission.dicoding.architecturecomponent.repository
...
class Repository {
    ...
    fun getMovie() : ArrayList<Movie> {
        ...
        moviesList.add(Movie("Angel Has Fallen",
        ...
        moviesList.add(Movie("Godzilla: King of the Monsters",
            release = "May 31, 2019",
        ...
        moviesList.add(Movie("Shazam!",
            release = "March 23, 2019",
            overview = "A boy is given the ability to become an adult superhero in times of need with a single magic word.",
            genre = "Action, Fantasy Comedy",
            runtime = "2h 12m",
            photo = R.drawable.shazam))
        moviesList.add(Movie("Pokémon Detective Pikachu",
            release = "May 10, 2019",
    ...
    fun getTvShow() : ArrayList<TvShow> {
        ...
        tvShowList.add(TvShow("Family Guy",
        ...
        tvShowList.add(TvShow("Game of Thrones",
        ...
        tvShowList.add(TvShow("Rick and Morty",
        ...
        tvShowList.add(TvShow("The Seven Deadly Sins",
        ...
        tvShowList.add(TvShow("Marvel\\'s Agents of S.H.I.E.L.D.",
        ...
        tvShowList.add(TvShow("South Park",
        ...
        tvShowList.add(TvShow("Supernatural",
